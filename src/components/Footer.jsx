...
const Footer = () => {
  return (
    <div className="w-full h-screen">
      <div className="w-full min-h-screen bg-zinc-800 border-t-2 border-zinc-700 -mt-10 flex gap-5">
        <div className="w-1/2 min-h-full p-20 flex flex-col justify-between relative">
          <div className="heading">
            <h1 className="-mb-10 uppercase text-[9vw] font-medium leading-none font-['Founders_Grotesk_X']">
              eye-
            </h1>
            <h1 className="uppercase text-[9vw] font-medium leading-none font-['Founders_Grotesk_X']">
              opening
            </h1>
          </div>
        ...
        <div className="w-1/2 ">
          <h1 className="py-20 uppercase text-[9vw] font-medium leading-none font-['Founders_Grotesk_X'] -mb-20">
            Presentations
          </h1>
          <div className="flex justify-between gap-[18vw] items-center ">
            <div className="w-1/2">
              <div className="links ">
                {["S:", "Instagram", "Behance", "Facebook", "LinkedIn"].map(
                  (item, index) => (
                    <a
                      className={`block text-[1.2vw] text-zinc-300 font-['Neue_Montreal'] ${
                        index !== 0 && "underline-effect-2 cursor-pointer"
                      } ${index === 0 && "mb-3"}`}
                      key={index}
                    >
                      {item}
              ...
              <div className="links mt-7">
                {[
                  ...
                  <a
                    className={`block text-[1.2vw] text-zinc-300 font-['Neue_Montreal']  ${
                      index !== 0 && "underline-effect-3 cursor-pointer"
                    } ${index === 0 ? "mb-3" : index === 2 ? "mb-6" : index === 3 ? "underline-effect-4" : index === 4 ? "underline-effect-5" : null}`}
                    key={index}
                  >
                    {item}
                  </a>
              ...
              <div className="links mt-20 pb-7 ">
                <h1 className="text-lg font-['Neue_Montreal'] text-zinc-600">
                  ©Ochi design 2024.{" "}
            ...
            <div className="w-1/2">
              <div className="links">
                {[
                  ...
                  <a
                    className={`flex flex-col text-[1.2vw] text-zinc-300 font-['Neue_Montreal'] ${
                      index !== 0 && "underline-effect-2 cursor-pointer " 
                    } ${index === 0 ? "mt-20 mb-5" : index === 1 ? "underline-effect-6" : index === 5 ? "underline-effect-7" : index === 6 ? "underline-effect-8" : null}`}
                    key={index}
                  >
                    {item}
                  </a>
